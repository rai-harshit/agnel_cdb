...
<form id="form2-1" action="stage2-2.php" method="POST" autocomplete="on" width='99%'>
...
<tr> <td align="right" style="padding-top: 10px"><label>Employee ID :</label></td>
	<td><input type="text" name="college_emp_id" id="emid" style="width: 65%;margin-right: 28px;" required></td>
	</tr>
...
<h2>Highest Qualification</h2>*(Attach Proof)<br><br>
 <table>
    <tr>
   <td  align="right"><input type="radio" name="highest_qualif" value="post_phd" id="phd" required="required"/></td>
   <td><label> Post Ph.D (Specialization)</label></td>
	</tr>
	
	<tr>
   <td  align="right"><input type="radio" name="highest_qualif" value="phd" id="phd"/></td>
   <td><label> Ph.D (Specialization)</label></td>
	</tr>
	
	<tr>
   <td  align="right"><input type="radio" name="highest_qualif" value="mphil" id="mphil"/></td>
	<td><label>M.Phil (Specialization)</label></td>
	
	</tr>
	<tr>
   <td  align="right"><input type="radio" name="highest_qualif" value="me" id="me"/></td>
	<td><label>M.E (Specialization)</label></td>
	</tr>
	<tr>
   <td  align="right"><input type="radio" name="highest_qualif" value="ms" id="ms"/></td>
	<td><label>M.S (Specialization)</label></td>
	<!--cmi=College Magzine Incharge--> 
	</tr>
	<tr>
   <td  align="right"><input type="radio" name="highest_qualif" value="mtech" id="mtech"/></td>
	<td><label>M.Tech (Specialization)</label></td>
	<!--hod=Head Of Department--> 
	</tr>
	<tr>
   <td  align="right"><input type="radio" name="highest_qualif" value="msc" id="msc"/></td>
	<td><label>M.Sc (Specialization)</label></td>
	<!--c=Co-ordinator--> 
	</tr>
	<tr>
   <td  align="right"><input type="radio" name="highest_qualif" value="ma" id="ma"/></td>
	<td><label>M.A (Specialization)</label></td>
	<!--coe=Controller of Examination--> 
	</tr>
	<tr>
   <td  align="right"><input type="radio" name="highest_qualif" value="be" id="be"/></td>
	<td><label>B.E (Specialization)</label></td>
	<!--dcoe=Deputy Controller of Examination--> 
	</tr>
	<tr>
   <td  align="right"><input type="radio" name="highest_qualif" value="bs" id="bs"/></td>
	<td><label>B.S (Specialization)</label></td>
	<!--fcc=Falicitaion Centre Co-ordinator--> 
	</tr>
	<tr>
   <td  align="right"><input type="radio" name="highest_qualif" value="btech" id="btech"/></td>
	<td><label>B.Tech (Specialization)</label></td>
	<!--fcc=First Year Engineering Admission--> 
	</tr>
	<tr>
   <td  align="right"><input type="radio" name="highest_qualif" value="diploma" id="diploma"/></td>
	<td><label>Diploma (Specialization)</label></td>
	<!--sci=Student Council Incharge--> 
	</tr>
		<tr>
   <td  align="right"><input type="radio" name="highest_qualif" value="bsc" id="bsc"/></td>
	<td><label>B.Sc (Specialization)</label></td>
	<!--sci=Student Council Incharge--> 
	</tr>
		<tr>
   <td  align="right"><input type="radio" name="highest_qualif" value="ba" id="ba"/></td>
	<td><label>B.A (Specialization)</label></td>
	<!--sci=Student Council Incharge--> 
	</tr>
	<tr>
	<td align="right" style="padding-top: 15px"><label>Any Other Specialization</label></td>
	<td align="left"><input style="width:65%" type="text" name="other_specialization" id="other"/></td>
		</tr>
  </table>
 </div>
...
<div align="center">
<input type="submit" name="submit_stage2-1" value="SUBMIT DETAILS" style="width: 230px;margin-top: 15px;margin-bottom: 8px; height:40px;" onclick="submitForms()">
</div>
</br></br>
</form>
</center>
